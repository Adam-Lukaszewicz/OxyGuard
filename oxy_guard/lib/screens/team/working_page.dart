...
class WorkingPage extends StatefulWidget {
  const WorkingPage({super.key, required this.teams});
...
class _WorkingPageState extends State<WorkingPage> with AutomaticKeepAliveClientMixin, TickerProviderStateMixin {
